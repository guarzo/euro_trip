...
It is also the strongest option for Bubu and Gaby. West End theatre, Camden, the Louvre, the Amsterdam Light Festival, no language barrier in London — these land better at 17 and 15 than a fourth archaeological site.
...
- **If we would rather do three nights in four places than five nights in three** — pace tolerance is the real constraint here, and I am guessing at it. See [Pace]({{ '/questions/pace/' | relative_url }}).
